                ...
                {analysisData?.wallet_cluster && (
                  <div className="intelCard">
                    ...
                    <InfoRow
                      label="Cluster Size"
                      value={
                        analysisData.wallet_cluster.cluster_size ?? 0
                      }
                    />
                    ...
                    <InfoRow
                      label="Type"
                      value={
                        analysisData.wallet_cluster.cluster_type ===
                    ...
                    <InfoRow
                      label="Confidence"
                      value={
                        analysisData.wallet_cluster.confidence || "—"
                      }
                    />
                    ...
                    <div className="selectedWallet">
                      ...
                      <div className="selectedAddress">
                        {analysisData.wallet_cluster.root_wallet || "—"}
                      </div>
                    </div>

                    {analysisData.wallet_cluster.wallets?.length > 1 && (
                      <div className="patternList">
                        {analysisData.wallet_cluster.wallets
                          .slice(1, 7)
                          .map((wallet, index) => (
                            <div
                        ...
                        {analysisData.wallet_cluster.wallets.length > 7 && (
                          <div className="pendingModule">
                            +{analysisData.wallet_cluster.wallets.length - 7}{" "}
                    ...
                    {analysisData.wallet_cluster.reasons?.length > 0 && (
                      <div className="alertReasons">
                        {analysisData.wallet_cluster.reasons.map(
                          (reason, index) => (
                            <div key={index}>
                              • {reason}
                            </div>
                    ...
                    <div className="pendingModule">
                      {analysisData.wallet_cluster.disclaimer ||
                        "Behavioral clustering indicates transaction relationships only and does not prove common ownership."}
                    </div>
                  </div>
                )}
